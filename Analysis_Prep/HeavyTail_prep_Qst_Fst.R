...
input_path="path/HeavyTail/divergence_output/mut_track/"
...
HeavyTail=do.call(rbind,lapply(files_general,function(f){
...
saveRDS(HeavyTail,paste0(output_path,"HeavyTail.RDS"))
